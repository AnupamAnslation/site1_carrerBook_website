    ...
    return (
        ...
        >
            ...
            >
                {/* LEFT CONTENT */}
                <Box flex={1} pr={{ md: 6 }}>
                    <Typography variant="h3" fontWeight={300} gutterBottom sx={{ fontStyle: "normal" }}>
                    ...
                    <Typography variant="h6" mt={2} mb={4} color="gray.300">
                ...
                {/* RIGHT IMAGE */}
                <Box flex={1} mb={{ xs: 6, md: 0 }} display="flex" justifyContent="center">
                    <Image
                        src="/hero/hero.png"
                        alt="Hero Image"
                        width={900}
